...
root = Tk()
root.geometry("312x343")
root.resizable(0, 0)
root.title("Calculator")
root.wm_iconbitmap("GG.ico")
...
input_frame = Frame(root, width=312, height=50, bd=0, highlightbackground="black",
                    highlightthickness=2,relief=SUNKEN,bg="red",borderwidth=6)

input_frame.pack(side=TOP)



input_field = Entry(input_frame, font=('arial', 20, 'bold'), textvariable=input_text, width=50,fg="blue", bg="black", bd=0,
                    justify=RIGHT)
...
btns_frame = Frame(root, width=312, height=272.5, bg="maroon",relief=GROOVE,borderwidth=4)

btns_frame.pack()



clear = Button(btns_frame, text="C", fg="RED", width=32, height=3, bd=0, bg="Orange", cursor="hand2",
...
seven = Button(btns_frame, text="7", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
               command=lambda: btn_click(7)).grid(row=1, column=0, padx=1, pady=1)

eight = Button(btns_frame, text="8", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
               command=lambda: btn_click(8)).grid(row=1, column=1, padx=1, pady=1)

nine = Button(btns_frame, text="9", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
...
four = Button(btns_frame, text="4", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
              command=lambda: btn_click(4)).grid(row=2, column=0, padx=1, pady=1)

five = Button(btns_frame, text="5", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
              command=lambda: btn_click(5)).grid(row=2, column=1, padx=1, pady=1)

six = Button(btns_frame, text="6", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
...
one = Button(btns_frame, text="1", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
             command=lambda: btn_click(1)).grid(row=3, column=0, padx=1, pady=1)

two = Button(btns_frame, text="2", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
             command=lambda: btn_click(2)).grid(row=3, column=1, padx=1, pady=1)

three = Button(btns_frame, text="3", fg="black", width=10, height=3, bd=0, bg="grey", cursor="hand2",
...
zero = Button(btns_frame, text="0", fg="black", width=21, height=3, bd=0, bg="light green", cursor="hand2",
              command=lambda: btn_click(0)).grid(row=4, column=0, columnspan=2, padx=1, pady=1)

point = Button(btns_frame, text=".", fg="black", width=10, height=3, bd=0, bg="light green", cursor="hand2",
